...
🔗 관련 정리: `notes/models/stable_diffusion/overview.md`
...
🔗 프로젝트 배경: `projects/dental-stream-diffusion/README.md`
...
🔗 Stream Diffusion 분석: `notes/models/stream_diffusion.md`  
🔗 ctrLoRA 구조 분석: `notes/models/stable_diffusion/ctrlora.md`
...
- 판단:
  - post-processing diffusion 방식의 구조적 한계 인식
...
- Stable Diffusion 계열 구조 정리  
  → `notes/models/stable_diffusion/`
- ControlNet / LoRA / ctrLoRA 분석  
  → `notes/models/stable_diffusion/`
- MV-Adapter, Skyfall-GS 논문 정리  
  → `notes/papers/`
- Dental domain 실시간 diffusion 프로젝트  
  → `projects/`
